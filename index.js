function App() {
    ...
    const calculate = () => {
        setAnswer(Math.round(1000000000000 * eval(expression))/1000000000000);
    ...
    return (
        <div className="header"><h1>JavaScript Calculator</h1>
        ...
        <div className = "grid">
           ...
           <div onClick={() => display("/")} className="padButton divides" id="divide">/</div>
           ...
           <div onClick={calculate} className="padButton equal green" id="equals">=</div>
